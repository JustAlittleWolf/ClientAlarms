...
public final class AlarmEngine {
    ...
    public static synchronized boolean toggleSilent(TrackableKind kind, String name) {
        ...
        markDirty();
        Notifier.info(Component.translatable(trackable.silent ? "clientalarms.message.silentOn" : "clientalarms.message.silentOff", trackable.name));
        return true;
    }
    ...
    public static synchronized boolean setOverlay(TrackableKind kind, String name, boolean visible) {
        ...
        markDirty();
        Notifier.info(Component.translatable(visible ? "clientalarms.message.shown" : "clientalarms.message.hidden", found.get().name));
        return true;
    }
